# -*- coding: utf-8 -*-
"""
Created on Fri Jul 10 01:12:29 2017
...
#C:\Users\ARSHDEEP SINGH\Desktop\Emotion detection

face_cascade = cv2.CascadeClassifier('/Users/ARSHDEEP SINGH\Desktop/Emotion detection/haarcascades/haarcascade_frontalface_default.xml')
#face_cascade = cv2.CascadeClassifier('/Users/tarananttal/anaconda3/envs/ComputerVision/share/OpenCV/haarcascades/haarcascade_frontalface_default.xml')
...
#C:\Users\ARSHDEEP SINGH\Desktop\my spectacle project\train
training_set = train_datagen.flow_from_directory('/Users/ARSHDEEP SINGH/Desktop/my spectacle project/train/',
...
#C:\Users\ARSHDEEP SINGH\Desktop\Emotion detection\Dataset1
test_set = test_datagen.flow_from_directory('/Users/ARSHDEEP SINGH/Desktop/my spectacle project/test/',
                                            target_size = (128, 128),
                                            batch_size = 1,
...
classifier.fit_generator(training_set,
                         samples_per_epoch = 83, #number of training example photos
...
while(cap.isOpened()):  # check !
    ...
    for (x,y,w,h) in faces:
        ...
        if (result[0][0] == 0):#result.all to handle multiple faces
            print("specs")
            cv2.putText(frame,"specs",(x,h), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (255, 255, 255), lineType=cv2.LINE_AA)
            #this is how to put text on image
        else:
            print("no specs found")
#        if (result[0][1] == 1):
#            print("sad")
            cv2.putText(frame,"no specs",(x,h), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (255, 255, 255), lineType=cv2.LINE_AA)
#        if (result[0][2] == 1):
#            print("smiling")
